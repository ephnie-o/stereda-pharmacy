...
export default function SteredexCoughSuppressant() {
  // Refs for sections
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row items-center mb-8">
          <div className="w-full md:w-1/3 flex justify-center">
            <Image
              src={steredexsupp}
              alt="Steredex Cough Suppressant"
              width={300}
              height={300}
          ...
          <div className="w-full md:w-2/3 mt-4 md:mt-0 md:ml-8 text-center md:text-left">
            <h1 className="text-4xl font-bold text-green-700 mb-4">Steredex Cough Suppressant Syrup</h1>
            <p className="text-lg text-zinc-600">Effective Relief for Dry and Persistent Coughs</p>
          </div>
        </div>
        ...
        <section ref={compositionRef} className="mb-8">
          ...
          <ul className="list-disc list-inside text-zinc-600">
            <li>Dextromethorphan Hydrobromide BP - 15mg</li>
            <li>Chlorpheniramine Maleate BP - 2mg</li>
        ...
        <section ref={usageRef} className="mb-8">
          <h2 className="text-2xl font-bold text-green-700 mb-4">What is Steredex Cough Suppressant and What is it Used For?</h2>
          <p className="text-zinc-600 mb-4">
            Steredex Cough Suppressant is specially formulated to relieve dry, persistent coughs by suppressing the cough reflex and reducing throat irritation. It also helps alleviate cold symptoms such as nasal congestion and sneezing.
          </p>
          <h3 className="text-xl font-semibold text-green-700 mb-2">Key Benefits:</h3>
          <ul className="list-disc list-inside text-zinc-600">
            <li className="mb-3">
              <strong>Dextromethorphan:</strong> A cough suppressant that reduces the urge to cough by acting on the cough center in the brain.
            </li>
            <li className="mb-3">
              <strong>Chlorpheniramine:</strong> An antihistamine that relieves symptoms like sneezing, runny nose, and itchy throat associated with allergies and colds.
            </li>
            <li className="mb-3">
              <strong>Phenylephrine:</strong> A nasal decongestant that reduces swelling in the nasal passages, improving airflow and relieving congestion.
            </li>
            <li className="mb-3">
        ...
        <section ref={precautionsRef} className="mb-8">
          ...
          <p className="text-zinc-600 mb-4">Do not take Steredex Cough Suppressant Syrup if you are allergic to any of its active ingredients. Consult your healthcare professional before taking this syrup if you:</p>
          <ul className="list-disc list-inside text-zinc-600">
            <li>Are pregnant or breastfeeding.</li>
            <li>Have high blood pressure or heart problems.</li>
          ...
          <p className="text-zinc-600 mt-4">Other cough syrups and STEREDEX COUGH SUPPRESSANT SYRUP. Tell your Healthcare Professional if you are taking, have recently taken, or might take any other medicines, or including medicine obtained without prescription.</p>
          <h2 className="text-xl font-semibold text-zinc-700 my-4">STEREDEX COUGH SUPPRESSANT SYRUP with food and drink</h2>
        ...
        <section ref={dosageRef} className="mb-8">
          <h2 className="text-2xl font-bold text-green-700 mb-4">How to Take Steredex Cough Suppressant?</h2>
          <p className="text-zinc-600 mb-4">
            The usual dose for adults and children over 12 years is 10 ml every 6–8 hours as needed, or as directed by your healthcare professional. Do not exceed the recommended dosage.
          </p>
          ...
          <h2 className="text-xl font-semibold text-zinc-700 my-4">If you forget to take STEREDEX COUGH SUPPRESSANT SYRUP</h2>
        ...
        <section ref={sideEffectsRef} className="mb-8">
          ...
          <p className="text-zinc-600">
            Steredex Cough Suppressant Syrup is likely safe. However, if you experience any side effects such as stomach upset, headache, nausea, or vomiting, stop taking the cough syrup and consult your healthcare professional immediately.
          </p>
        </section>

        {/* Storage Information */}
        <section ref={storageRef} className="mb-8">
          <h2 className="text-2xl font-bold text-green-700 mb-4">How to Store Steredex Cough Suppressant Syrup?</h2>
          <p className="text-zinc-600">
            Keep Steredex Cough Suppressant Syrup out of reach of children. Store at a temperature not exceeding 30°C. Do not use after the expiry date stated on the label or carton.
          </p>
        </section>
