...
export default function SteredexChesty() {
  // Refs for sections
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row items-center mb-8">
          <div className="w-full md:w-1/3 flex justify-center">
            <Image
              src={steredexchesty}
              alt="Steredex Chesty Cough Syrup 200ml"
              width={300}
              height={300}
          ...
          <div className="w-full md:w-2/3 mt-4 md:mt-0 md:ml-8 text-center md:text-left">
            <h1 className="text-4xl font-bold text-green-700 mb-4">Steredex Chesty Cough Syrup</h1>
            <p className="text-lg text-zinc-600">Chesty Cough Syrup for Kids and Adults</p>
          </div>
        </div>
        ...
        <section ref={compositionRef} className="mb-8">
          ...
          <ul className="list-disc list-inside text-zinc-600">
            <li>Terbutaline Sulphate BP - 1.25mg</li>
            <li>Bromhexine HCl BP - 4mg</li>
            <li>Guaphenesin BP - 50mg</li>
            <li>Menthol BP - 2.5MG</li>
        ...
        <section ref={usageRef} className="mb-8">
          <h2 className="text-2xl font-bold text-green-700 mb-4">What is Steredex Chesty Cough Syrup and What is it Used For?</h2>
          <p className="text-zinc-600 mb-4">
            Steredex Chesty Cough Syrup is specially formulated to help relieve chesty coughs associated with colds and respiratory infections. It helps loosen mucus (phlegm) and makes it easier to clear the chest.
          </p>
          <h3 className="text-xl font-semibold text-green-700 mb-2">Key Benefits:</h3>
          <ul className="list-disc list-inside text-zinc-600">
            <li className="mb-3">
                <strong>Terbutaline:</strong> A bronchodilator which opens up the airways to ease breathing.
            </li>
            <li className="mb-3">
                <strong>Bromhexine and Guaifenesin:</strong> A proven mucolytic and expectorant respectively, that work together to break down and loosen mucus, promoting effective clearance from the airways.
            </li>
            <li className="mb-3">
                <strong>Menthol:</strong> A cooling agent and mild analgesic that soothes throat irritation caused by coughing.
            </li>
            <li className="mb-3">
        ...
        <section ref={precautionsRef} className="mb-8">
          ...
          <p className="text-zinc-600 mb-4">Do not take Steredex Chesty Cough Syrup if you are allergic to any of its active ingredients. Consult your healthcare professional before taking this syrup if you:</p>
          <ul className="list-disc list-inside text-zinc-600">
            <li>Are pregnant or breastfeeding.</li>
            <li>Have asthma or other chronic respiratory diseases.</li>
            <li>Have a known intolerance to sugars (contains sucrose).</li>
            <li>Have kidney or liver problems.</li>
            <li>Are taking other cough or cold medications.</li>
          </ul>
          <p className="text-zinc-600 mt-4">Other cough syrups and STEREDEX CHESTY COUGH SYRUP. Tell your Healthcare Professional if you are taking, have recently taken, or might take any other medicines, or including medicine obtained without prescription.</p>
          <h2 className="text-xl font-semibold text-zinc-700 my-4">STEREDEX CHESTY COUGH SYRUP with food and drink</h2>
        ...
        <section ref={dosageRef} className="mb-8">
          <h2 className="text-2xl font-bold text-green-700 mb-4">How to Take Steredex Chesty Cough Syrup?</h2>
          <p className="text-zinc-600 mb-4">
          ...
          <h2 className="text-xl font-semibold text-zinc-700 my-4">If you forget to take STEREDEX CHESTY COUGH SYRUP</h2>
        ...
        <section ref={sideEffectsRef} className="mb-8">
          ...
          <p className="text-zinc-600">
            Steredex Chesty Cough Syrup is likely safe. However, if you experience any side effects such as stomach upset, headache, nausea, or vomiting, stop taking the cough syrup and consult your healthcare professional immediately.
          </p>
        </section>

        {/* Storage Information */}
        <section ref={storageRef} className="mb-8">
          <h2 className="text-2xl font-bold text-green-700 mb-4">How to Store Steredex Chesty Cough Syrup?</h2>
          <p className="text-zinc-600">
            Keep Steredex Chesty Cough Syrup out of reach of children. Store at a temperature not exceeding 30°C. Do not use after the expiry date stated on the label or carton.
          </p>
        </section>
